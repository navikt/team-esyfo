...
Etter innlogging på nav.no ser den sykmeldte en microfrontend på [Min side](https://www.nav.no/minside) med gjeldende status og lenke til aktivitetskrav-siden.
