...
`RETIRE` betyr heller ikke «slett nå». Hver pensjonering har enten verifisert/begrunnet bortfall eller en eksplisitt gate.
...
Registeret behandler denne repo-referansen som en **historisk kilde** og den berørte regelen som et oppryddingsfunn under utfasing. Den skal verifiseres og ryddes i NAIS, ikke brukes som bevis for at alle 25 gjeldende Prometheus-regler fortsatt styres av dagens kildekode. Kartleggingen har 10 nåværende default-branch-kilder og 1 historisk repo-kilde.

### Leveringsdrift: to registrerte workflow-gap

Ved siste snapshot var to kildefiler ikke pålitelig koblet til kontinuerlig levering, til sammen for sju observerte regelinstanser:
