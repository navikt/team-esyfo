...
| <span id="e11"></span>**Mikrofrontend på Min side** | Min side (mikrofrontend) | Modul på Min side som løfter fram oppfølgings-innholdet der den sykmeldte faktisk er. *Merk: foreløpig utenfor pakke 1; vurderes ved ledig tid* | — | [#140](https://github.com/navikt/team-esyfo/issues/140) |
