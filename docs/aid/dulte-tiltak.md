# 🧠 Dulte-tiltak (nudgelab)

Dette er **intensjonsnivået** i AID: adferdsgrepene som nudgelab har definert, forankret i adferdspsykologi. De beskriver *hva vi vil oppnå og hvorfor*. Det vi faktisk bygger står i [Funksjonelle endringer](./endringer) — koblingen mellom de to er mange-til-mange og veiledende.

Registeret er organisert etter **brukerreisen**: hvilket steg i forløpet grepet virker på. «Realiseres av» peker til den funksjonelle endringen som dekker grepet.

## Nærmeste leder {#leder}

Brukerreisen for nærmeste leder, i sju steg:

1. Får vite at den ansatte er sykmeldt
2. Logger på og ser sykmeldingen (varighet og gradering)
3. Vurderer behovet for en oppfølgingsplan (eller Nav ber om en, rundt uke 8)
4. Gjennomfører en samtale og lager planen
5. Deler planen med den ansatte og sender den til legen
6. Evaluerer og justerer planen innen 4 uker
7. Deler oppdatert plan med Nav og/eller fastlege
...
Brukerreisen for den sykmeldte, i åtte steg:

1. Gir beskjed til leder om at hen skal til legen
2. Er hos legen og blir sykmeldt
3. Tar i bruk sykmeldingen på Ditt sykefravær og sender den til arbeidsgiver
4. Snakker med arbeidsgiver om arbeidsevne, og vurderer behovet for en plan
5. Lager plan sammen med lederen og bidrar med egen arbeidsevne
6. Får beskjed fra Nav om å logge inn
7. Ser at lederen har laget en plan, og om den er delt med lege/Nav
8. Evaluerer tilretteleggingen sammen med lederen etter 4 uker
...
::: info Kilde
Registeret bygger på nudgelab sitt tiltaksdokument for oppfølgingsplan. Det er intensjonsnivået — se [Funksjonelle endringer](./endringer) for hva vi faktisk bygger, og [Måling](./maaling) for hvordan vi vurderer effekt.
:::
